...
4. Разработал плагин: Для получения быстрых заявок от клиентов и хранения информации о них в базе данных (MySQL / MariaDB)
6. Кроме того, для работы с 2696 товарами использовал API Woocommerce, Wordpress
7. Дорабатывал плагин Yoast Seo для того чтобы он соотвествовал запросам проекта
